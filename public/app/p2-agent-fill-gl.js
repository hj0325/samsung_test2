(function () {
  ...
  var FRAG_SRC = [
    ...
    '    * (0.068 + early * 0.082) * max(s, 0.06);',
    '  float ripple = sin(time * 1.05 + atan(rel.y, rel.x + 0.0001) * 4.0',
    '    + fbm(rel * 3.0 + time * 0.04) * 2.5) * 0.024 * max(early, 0.32);',
    '  dist += ripple + wobble * 0.42;',
    ...
    '  float softLead = max(0.30, 0.44 * s + early * 0.26 + audio * 0.028);',
    '  float softTrail = softLead * 1.72;',
    '  float revealCore = 1.0 - smoothstep(',
    '    localFront - softLead * 0.78 + wobble,',
    '    localFront + softTrail * 0.92 + wobble,',
    '    dist',
    '  );',
    '  float revealWide = 1.0 - smoothstep(',
    '    localFront - softLead * 1.85 + wobble * 0.8,',
    '    localFront + softTrail * 2.35 + wobble * 0.8,',
    '    dist',
    '  );',
